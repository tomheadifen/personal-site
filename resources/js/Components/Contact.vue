            ...
            <div class="bg-warm-gray-50">
                <div class="py-12 lg:py-16">
                    <div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
                        <h1
                            class="text-4xl font-extrabold tracking-tight text-warm-gray-900 sm:text-5xl lg:text-5xl"
                        >Get in touch with me</h1>
                        <p
                            class="mt-6 text-xl text-warm-gray-500 max-w-3xl"
                        >Whether it be for a chat or if you think we could work together feel free to reach out.</p>
                    </div>
                </div>
            </div>
