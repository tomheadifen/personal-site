<template>
    <div class="bg-white">
        <main class="mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-extrabold tracking-tight text-warm-gray-900 sm:text-5xl lg:text-5xl pb-10">Who am I?</h2>
            <div class="grid grid-cols-12">
                <div class="col-span-6">
                    <ul class="text-4xl list-none pl-10 space-y-5">
                        <li>- Team Leader</li>
